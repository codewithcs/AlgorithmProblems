...
public class CalendarMatching {
	...
	public static void main(String[] args) {
		...
		StringMeeting meeting = new StringMeeting("9:00", "10:30");
		calendar1.add(meeting);
		meeting = new StringMeeting("12:00", "13:00");
		calendar1.add(meeting);
		meeting = new StringMeeting("16:00", "18:00");
		calendar1.add(meeting);

		List<StringMeeting> calendar2 = new ArrayList<>();
		meeting = new StringMeeting("10:00", "11:30");
		calendar2.add(meeting);
		meeting = new StringMeeting("12:30", "14:30");
		calendar2.add(meeting);
		meeting = new StringMeeting("14:30", "15:00");
		calendar2.add(meeting);
		meeting = new StringMeeting("16:00", "17:00");
		calendar2.add(meeting);

		StringMeeting dailyBound1 = new StringMeeting("9:00", "20:00");
		StringMeeting dailyBound2 = new StringMeeting("10:00", "18:30");

		for(StringMeeting output: calendarMatching(calendar1, dailyBound1, calendar2, dailyBound2, 30)){
			System.out.print("[ " + output.start + ", " + output.end + " ]");
			System.out.println();
		}
	}
	 ...
	 public static List<StringMeeting> calendarMatching(List<StringMeeting> calendar1, StringMeeting dailyBounds1, 
	 	...
	 	// We are converting the time to minutes and using the military time to prevent clash of 9:30 and 21:30 if 21:30 is written as 9:30. 
