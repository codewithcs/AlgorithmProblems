...
public class RemoveAllAdjacentDuplicatesInString2 {
    ...
    public String removeDuplicates2_Optimized(String s, int k) {
        ...
        for(int i=0; i< sb.length(); i++){ // sb.length() will change with every deletion.
            if(i==0 || sb.charAt(i) != sb.charAt(i-1)){
                ...
                if(count[i] == k){
                    sb.delete(i-k+1, i+1);
                    i = i - k;
                    // We set this as i-k and not i-k+1 because i will get incremented in the for loop.
                    // This line makes the time complexity O(n).
                }
            }
        }
